...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 1. Unités
        $unites = [
            ['nom' => 'mg', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'ml', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'UI', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Comprimé', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Gélule', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Sirop', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Injection', 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        $familles = [
            ['nom' => 'Antibiotiques', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Antalgiques', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Anti-inflammatoires', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Antihypertenseurs', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Antidiabétiques', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Vitamines', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Antidépresseurs', 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        // 3. Assurances
        $assurances = [
            ['nom' => 'CNSS', 'telephone' => '0800100100', 'adresse' => 'Dakar', 'taux' => 80, 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'IPM', 'telephone' => '0800200200', 'adresse' => 'Dakar', 'taux' => 70, 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Aucune', 'telephone' => null, 'adresse' => null, 'taux' => 0, 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        // 4. Services médicaux
        $services = [
            ['nom' => 'Médecine Générale', 'description' => 'Service de médecine générale', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Pédiatrie', 'description' => 'Service pédiatrique', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Gynécologie', 'description' => 'Service gynécologie-obstétrique', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Cardiologie', 'description' => 'Service de cardiologie', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Urgences', 'description' => 'Service des urgences', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Laboratoire', 'description' => 'Service de laboratoire d\'analyses', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Radiologie', 'description' => 'Service de radiologie', 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        // 5. Prestations
        $prestations = [
            ['service_medical_id' => $serviceIds['Médecine Générale'], 'nom' => 'Consultation générale', 'description' => 'Consultation médicale standard', 'quantifiable' => false, 'prix' => 5000, 'created_at' => now(), 'updated_at' => now()],
            ['service_medical_id' => $serviceIds['Pédiatrie'], 'nom' => 'Consultation pédiatrique', 'description' => 'Consultation pour enfants', 'quantifiable' => false, 'prix' => 6000, 'created_at' => now(), 'updated_at' => now()],
            ['service_medical_id' => $serviceIds['Gynécologie'], 'nom' => 'Consultation gynécologique', 'description' => 'Consultation spécialisée', 'quantifiable' => false, 'prix' => 7000, 'created_at' => now(), 'updated_at' => now()],
            ['service_medical_id' => $serviceIds['Cardiologie'], 'nom' => 'Consultation cardiologique', 'description' => 'Consultation cœur', 'quantifiable' => false, 'prix' => 8000, 'created_at' => now(), 'updated_at' => now()],
            ['service_medical_id' => $serviceIds['Laboratoire'], 'nom' => 'NFS', 'description' => 'Numération formule sanguine', 'quantifiable' => true, 'prix' => 3000, 'created_at' => now(), 'updated_at' => now()],
            ['service_medical_id' => $serviceIds['Laboratoire'], 'nom' => 'Glycémie', 'description' => 'Taux de sucre dans le sang', 'quantifiable' => true, 'prix' => 1500, 'created_at' => now(), 'updated_at' => now()],
            ['service_medical_id' => $serviceIds['Radiologie'], 'nom' => 'Radio thorax', 'description' => 'Radiographie pulmonaire', 'quantifiable' => false, 'prix' => 10000, 'created_at' => now(), 'updated_at' => now()],
            ['service_medical_id' => $serviceIds['Radiologie'], 'nom' => 'Échographie', 'description' => 'Échographie abdominale', 'quantifiable' => false, 'prix' => 15000, 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        // 6. Examens
        $examens = [
            ['nom' => 'Bilan sanguin complet', 'description' => 'Analyse complète du sang', 'prix' => 20000, 'service_medical_id' => $serviceIds['Laboratoire'], 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Électrocardiogramme', 'description' => 'ECG', 'prix' => 12000, 'service_medical_id' => $serviceIds['Cardiologie'], 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'IRM cérébrale', 'description' => 'Imagerie par résonance magnétique', 'prix' => 50000, 'service_medical_id' => $serviceIds['Radiologie'], 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        // 7. Maladies
        $maladies = [
            ['nom' => 'Paludisme', 'description' => 'Infection parasitaire transmise par les moustiques', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Hypertension artérielle', 'description' => 'Pression artérielle élevée chronique', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Diabète de type 2', 'description' => 'Trouble de la régulation du sucre dans le sang', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Gastro-entérite', 'description' => 'Inflammation de l\'estomac et des intestins', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Infection respiratoire', 'description' => 'Infection des voies respiratoires', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Grossesse normale', 'description' => 'Suivi de grossesse normale', 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        // 8. Symptômes
        $symptomes = [
            ['nom' => 'Fièvre', 'description' => 'Température corporelle élevée', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Céphalées', 'description' => 'Maux de tête', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Toux', 'description' => 'Toux sèche ou grasse', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Douleur thoracique', 'description' => 'Douleur dans la poitrine', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Nausées', 'description' => 'Envie de vomir', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Fatigue', 'description' => 'Fatigue générale', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Dyspnée', 'description' => 'Essoufflement', 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        $maladieSymptomes = [
            ['maladie_id' => $maladieIds['Paludisme'], 'symptome_id' => $symptomeIds['Fièvre'], 'created_at' => now(), 'updated_at' => now()],
            ['maladie_id' => $maladieIds['Paludisme'], 'symptome_id' => $symptomeIds['Céphalées'], 'created_at' => now(), 'updated_at' => now()],
            ['maladie_id' => $maladieIds['Paludisme'], 'symptome_id' => $symptomeIds['Fatigue'], 'created_at' => now(), 'updated_at' => now()],
            ['maladie_id' => $maladieIds['Hypertension artérielle'], 'symptome_id' => $symptomeIds['Céphalées'], 'created_at' => now(), 'updated_at' => now()],
            ['maladie_id' => $maladieIds['Hypertension artérielle'], 'symptome_id' => $symptomeIds['Douleur thoracique'], 'created_at' => now(), 'updated_at' => now()],
            ['maladie_id' => $maladieIds['Gastro-entérite'], 'symptome_id' => $symptomeIds['Nausées'], 'created_at' => now(), 'updated_at' => now()],
            ['maladie_id' => $maladieIds['Infection respiratoire'], 'symptome_id' => $symptomeIds['Toux'], 'created_at' => now(), 'updated_at' => now()],
            ['maladie_id' => $maladieIds['Infection respiratoire'], 'symptome_id' => $symptomeIds['Fièvre'], 'created_at' => now(), 'updated_at' => now()],
        ];
        foreach ($maladieSymptomes as $ms) {
        ...
        $medicaments = [
            [
                ...
                'famille_id' => $familleIds['Antalgiques'], 'created_at' => now(), 'updated_at' => now()
            ],
            [
                ...
                'famille_id' => $familleIds['Anti-inflammatoires'], 'created_at' => now(), 'updated_at' => now()
            ],
            [
                ...
                'famille_id' => $familleIds['Antibiotiques'], 'created_at' => now(), 'updated_at' => now()
            ],
            [
            ...
            [
                ...
                'famille_id' => $familleIds['Vitamines'], 'created_at' => now(), 'updated_at' => now()
            ],
        ];
        ...
        $users = [
            [
                ...
                'remember_token' => Str::random(10), 'email_verified_at' => now(), 'created_at' => now(), 'updated_at' => now()
            ],
            [
        ...
        // 12. Salles
        $salles = [
            ['nom' => 'Salle A101', 'type' => 'Hospitalisation', 'service_medical_id' => $serviceIds['Médecine Générale'], 'capacite' => 10, 'prix' => 15000, 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Salle B202', 'type' => 'Hospitalisation', 'service_medical_id' => $serviceIds['Pédiatrie'], 'capacite' => 8, 'prix' => 12000, 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'Salle Urgences', 'type' => 'Urgences', 'service_medical_id' => $serviceIds['Urgences'], 'capacite' => 5, 'prix' => 20000, 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        // 13. Lits
        $lits = [
            ['numero' => 'LIT-001', 'salle_id' => $salleIds['Salle A101'], 'statut' => 'Libre', 'created_at' => now(), 'updated_at' => now()],
            ['numero' => 'LIT-002', 'salle_id' => $salleIds['Salle A101'], 'statut' => 'Libre', 'created_at' => now(), 'updated_at' => now()],
            ['numero' => 'LIT-003', 'salle_id' => $salleIds['Salle A101'], 'statut' => 'Occupé', 'created_at' => now(), 'updated_at' => now()],
            ['numero' => 'LIT-004', 'salle_id' => $salleIds['Salle B202'], 'statut' => 'Libre', 'created_at' => now(), 'updated_at' => now()],
            ['numero' => 'LIT-005', 'salle_id' => $salleIds['Salle B202'], 'statut' => 'Libre', 'created_at' => now(), 'updated_at' => now()],
            ['numero' => 'LIT-006', 'salle_id' => $salleIds['Salle Urgences'], 'statut' => 'Libre', 'created_at' => now(), 'updated_at' => now()],
        ];
        foreach ($lits as $lit) {
        ...
        $patients = [
            [
                ...
                'fin_validite_assurance' => '2025-12-31', 'est_decede' => false, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                ...
                'fin_validite_assurance' => '2025-10-31', 'est_decede' => false, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                ...
                'fin_validite_assurance' => null, 'est_decede' => false, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                ...
                'fin_validite_assurance' => '2025-11-30', 'est_decede' => false, 'created_at' => now(), 'updated_at' => now()
            ],
        ];
        ...
        $tickets = [
            [
                ...
                'date_validite' => Carbon::now()->addDays(7), 'statut' => 'valide', 'created_at' => now(), 'updated_at' => now()
            ],
            [
        ...
        $consultations = [
            [
                ...
                'grossesse_id' => null, 'created_at' => now(), 'updated_at' => now()
            ],
            [
        ...
        // 19. Ordonnances
        $ordonnances = [
            ['consultation_id' => $consultationIds[0], 'date' => Carbon::now()->subDays(2), 'date_paiement' => null, 'statutordo' => 'impaye', 'created_at' => now(), 'updated_at' => now()],
            ['consultation_id' => $consultationIds[1], 'date' => Carbon::now()->subDays(5), 'date_paiement' => Carbon::now()->subDays(4), 'statutordo' => 'paye', 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        $ordoMedicaments = [
            [
                ...
                'statut_vente' => 'disponible', 'created_at' => now(), 'updated_at' => now()
            ],
            [
            ...
            [
                ...
                'statut_vente' => 'non_disponible', 'created_at' => now(), 'updated_at' => now()
            ],
        ];
        foreach ($ordoMedicaments as $om) {
            DB::table('ordonnance_medicaments')->insert($om);
        }

        // 21. Prescriptions examens
        $prescriptionsExamens = [
            ['consultation_id' => $consultationIds[0], 'examen' => 'NFS', 'statut' => 'realise', 'notes' => 'Résultats disponibles', 'created_at' => now(), 'updated_at' => now()],
            ['consultation_id' => $consultationIds[1], 'examen' => 'Radio thorax', 'statut' => 'en_cours', 'notes' => 'À réaliser', 'created_at' => now(), 'updated_at' => now()],
        ];
        foreach ($prescriptionsExamens as $pe) {
        ...
        DB::table('resultats_examens')->insert([
            ['prescription_examen_id' => $prescriptionExamenIds[0], 'resultat' => 'Hémoglobine: 12g/dL, Globules blancs: 8000/mm³', 'fichier' => null, 'created_at' => now(), 'updated_at' => now()],
        ]);

        // 23. Certificats
        DB::table('certificats')->insert([
            ['consultation_id' => $consultationIds[0], 'date' => Carbon::now()->subDays(2), 'contenu' => 'Repos de 3 jours pour paludisme', 'created_at' => now(), 'updated_at' => now()],
        ]);

        // 24. Rendez-vous
        $rendezvous = [
            ['consultation_id' => null, 'patient_id' => $patientIds['Sarr'], 'medecin_id' => $userIds['doctor@example.com'],
             'date_heure' => Carbon::now()->addDays(3), 'motif' => 'Contrôle tension', 'statut' => 'prevu', 'created_at' => now(), 'updated_at' => now()],
            ['consultation_id' => $consultationIds[1], 'patient_id' => $patientIds['Diop'], 'medecin_id' => $userIds['doctor2@example.com'],
             'date_heure' => Carbon::now()->subDays(5), 'motif' => 'Consultation initiale', 'statut' => 'realise', 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        // 26. Fournisseurs
        $fournisseurs = [
            ['nom' => 'Pharma-Sénégal', 'contact' => '771112233', 'email' => 'contact@pharmasn.com', 'adresse' => 'Dakar', 'created_at' => now(), 'updated_at' => now()],
            ['nom' => 'MedicAfrique', 'contact' => '772223344', 'email' => 'info@medicafrique.com', 'adresse' => 'Thiès', 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        $commandes = [
            [
                ...
                'statut' => 'valide', 'StatutPaiement' => 'total', 'total' => 150000, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'reference' => 'CMD-2025-002', 'fournisseur_id' => $fournisseurIds['MedicAfrique'], 'date_commande' => Carbon::now()->subDays(10),
                'statut' => 'en_cours', 'StatutPaiement' => 'partielle', 'total' => 200000, 'created_at' => now(), 'updated_at' => now()
            ],
        ];
        ...
        $commandeMedicaments = [
            ['commande_id' => $commandeIds[0], 'medicament_id' => $medicamentIds['Paracétamol 500mg'], 'quantite' => 200, 'quantiterecue' => 200, 'prix_unitaire' => 400, 'total' => 80000, 'created_at' => now(), 'updated_at' => now()],
            ['commande_id' => $commandeIds[0], 'medicament_id' => $medicamentIds['Ibuprofène 400mg'], 'quantite' => 100, 'quantiterecue' => 100, 'prix_unitaire' => 700, 'total' => 70000, 'created_at' => now(), 'updated_at' => now()],
            ['commande_id' => $commandeIds[1], 'medicament_id' => $medicamentIds['Amoxicilline 500mg'], 'quantite' => 150, 'quantiterecue' => 100, 'prix_unitaire' => 1000, 'total' => 150000, 'created_at' => now(), 'updated_at' => now()],
        ];
        foreach ($commandeMedicaments as $cm) {
        ...
        // 30. Réception lignes
        $receptionLignes = [
            ['reception_id' => $receptionIds[0], 'medicament_id' => $medicamentIds['Paracétamol 500mg'], 'quantite_commandee' => 200, 'quantite_recue' => 200, 'prix_unitaire' => 400, 'lot' => 'LOT001', 'date_peremption' => '2026-12-31', 'created_at' => now(), 'updated_at' => now()],
            ['reception_id' => $receptionIds[0], 'medicament_id' => $medicamentIds['Ibuprofène 400mg'], 'quantite_commandee' => 100, 'quantite_recue' => 100, 'prix_unitaire' => 700, 'lot' => 'LOT002', 'date_peremption' => '2026-10-31', 'created_at' => now(), 'updated_at' => now()],
        ];
        foreach ($receptionLignes as $rl) {
            DB::table('reception_lignes')->insert($rl);
        }

        // 31. Paiement commandes
        $paiementCommandes = [
            ['commande_id' => $commandeIds[0], 'montant' => 150000, 'mode' => 'virement', 'date_paiement' => Carbon::now()->subDays(14), 'reference' => 'PCMD-2025-001', 'observations' => 'Paiement intégral', 'created_at' => now(), 'updated_at' => now()],
            ['commande_id' => $commandeIds[1], 'montant' => 100000, 'mode' => 'espèce', 'date_paiement' => Carbon::now()->subDays(9), 'reference' => 'PCMD-2025-002', 'observations' => 'Paiement partiel', 'created_at' => now(), 'updated_at' => now()],
        ];
        foreach ($paiementCommandes as $pc) {
        ...
        $grossesses = [
            ['patient_id' => $patientIds['Diop'], 'ddr' => '2026-01-15', 'dpa' => '2026-10-22', 'parite' => 0, 'gestite' => 1,
             'antecedents_particuliers' => null, 'statut' => 'En cours', 'date_fin' => null, 'created_at' => now(), 'updated_at' => now()],
        ];
        ...
        $consultationPrenatale = [
            ...
            'groupe_sanguin' => 'A+', 'adresse_patient' => 'Guédiawaye', 'antecedents' => null,
            'grossesse_id' => $grossesseIds[0], 'created_at' => now(), 'updated_at' => now()
        ];
        ...
        DB::table('suivis')->insert([
            [
                ...
                'statut' => 'prevu', 'created_at' => now(), 'updated_at' => now()
            ],
        ]);
        ...
        DB::table('suivi_traitements')->insert([
            [
                ...
                'temperature' => '37.5', 'tension' => '125/80', 'created_at' => now(), 'updated_at' => now()
            ],
        ]);
        ...
        $protocoles = [
            [
                ...
                'remarques' => 'Adapté selon poids', 'created_at' => now(), 'updated_at' => now()
            ],
        ];
        ...
        if (!empty($protocoleIds)) {
            DB::table('protocole_medicament')->updateOrInsert(
                ...
                ['protocole_id' => $protocoleIds[0], 'medicament_id' => $medicamentIds['Artésunate injectable'], 'type' => 'principal', 'posologie' => '2.4 mg/kg', 'duree' => '3 jours', 'created_at' => now(), 'updated_at' => now()]
            );
        }

        // 40. Consultation suggestions (IA)
        $consultationSuggestions = [
            ['consultation_id' => $consultationIds[0], 'pathologie_id' => $maladieIds['Paludisme'], 'score' => 95, 'niveau_confiance' => 'Très élevé', 'created_at' => now(), 'updated_at' => now()],
            ['consultation_id' => $consultationIds[0], 'pathologie_id' => $maladieIds['Infection respiratoire'], 'score' => 25, 'niveau_confiance' => 'Faible', 'created_at' => now(), 'updated_at' => now()],
        ];
        foreach ($consultationSuggestions as $cs) {
