...
class MaladiesSeederCustom extends Seeder
{
    public function run(): void
    {
        $maladies = [
            ...
            ['nom' => "Otite moyenne aiguë (OMA)", 'description' => "Infection aiguë de l'oreille moyenne, fréquente chez le genre enfant, souvent secondaire à une rhinopharyngite."],
            ...
            ['nom' => "Onchocercose (cécité des rivières)", 'description' => "Filariose cutanéo-oculaire transmise par simulies, pouvant entraîner prurit, laisses cutanées et cécité."],
            ...
            ['nom' => "Trypanosomiase humaine africaine (maladie du sommeil)", 'description' => "Infection parasitaire transmise par la mouche tsé-tsé, évoluant en une phase hémo-lymphatique puis neurologique."],
            ...
            ['nom' => "Écoulement vaginal anormal", 'description' => "Leucorrhées anormales en abondance, couleur ou odeur, signe d'appel d'une infection génitale basse."],
