...
class ProtocoleMedicamentSeederCustom extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($liens as $maladieNom => $meds) {
            ...
            foreach ($meds as [$medNom, $type, $posologie, $duree]) {
                // Pour faire correspondre "Amoxicilline" avec "Amoxicilline 500mg" ou "Amoxicilline 250mg/5ml Sirop"
                // On va faire un select LIKE ou similaire
                $medicament = Medicament::where('nom', 'LIKE', $medNom . '%')->first();
                if (!$medicament) {
                    continue;
                }
