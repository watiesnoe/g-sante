    ...
    <div class="login-container">
        ...
        <div class="login-left">
            <div class="illustration-text">
                <div class="mb-4">
                    <img src="{{ asset('image/logo/logo3.png') }}" class="shadow-lg"
                        style="max-height: 150px; background-color: white; border-radius: 50%; padding: 10px;"
                        alt="Centre Santé Du Mali">
                </div>
                <h1>Mali Kènèya Hub</h1>
                <p>Le système de gestion hospitalière intelligent, ultra-sécurisé et innovant conçu pour simplifier
                    votre quotidien clinique.</p>
            </div>
        </div>
            ...
            <div class="form-container">
                ...
                @if ($errors->any())
                    <div class="alert alert-danger rounded-4 shadow-sm border-0 mb-4"
                        style="font-size: 0.95rem; background-color: #fee2e2; color: #991b1b;">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-floating mb-4">
                        <input type="email" class="form-control fw-medium" id="email" name="email"
                            value="{{ old('email') }}" placeholder="nom@hopital.com" required autofocus
                    ...
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control fw-medium" id="password" name="password"
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-5">
                        <div class="form-check custom-checkbox">
                            ...
                            <label class="form-check-label text-muted fw-medium user-select-none" for="remember_me"
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-decoration-none"
                                style="color: #1c61e7; font-size: 0.95rem; font-weight: 600;">
                                Mot de passe oublié ?
                            </a>
                        @endif
                    </div>
                ...
                <div class="mt-5 text-center text-muted fw-medium" style="font-size: 0.85rem;">
                    &copy; {{ date('Y') }} Ges-Santé &middot; Développé par <span
                        class="fw-bold text-primary">DigitAfrika</span>
                </div>
            </div>
        </div>
    </div>
