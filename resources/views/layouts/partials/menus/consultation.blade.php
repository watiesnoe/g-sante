        ...
        <div class="content-side">
            <ul class="nav-main">
                ...
                @if(auth()->user()->role === 'supadmin')
                    ...
                    @include('partials.sidebar-patients')
                    @include('partials.sidebar-tickets')
                    @include('partials.sidebar-consultations')
                    @include('partials.sidebar-rendezvous')
                    @include('partials.sidebar-ordonnances')
                    @include('partials.sidebar-examens')
                    @include('partials.sidebar-hospitalisation')
                    @include('partials.sidebar-stock')
                    @include('partials.sidebar-paiements')
