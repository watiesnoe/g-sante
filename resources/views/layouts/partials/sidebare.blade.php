        ...
        <div class="content-side">
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item"><a class="nav-main-link" href="#"><span class="nav-main-link-name">Liste des Consultations</span></a></li>
                        <li class="nav-main-item"><a class="nav-main-link" href="{{route('consultations.index')}}"><span class="nav-main-link-name">Nouvelle Consultation</span></a></li>
                    </ul>
                </li>
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        ...
                        <li class="nav-main-item"><a class="nav-main-link" href="{{route('rendezvous.annuler')}}"><span class="nav-main-link-name">Rendez-vous annuler</span></a></li>
                    </ul>
                </li>
                ...
                <!-- Analyses Médicales & Echographie -->
                <li class="nav-main-item">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" href="#">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item"><a class="nav-main-link" href="{{route('prescriptions.index')}}"><span class="nav-main-link-name">Analyses supplementaire</span></a></li>
                        <li class="nav-main-item"><a class="nav-main-link" href="{{route('reponses.index')}}"><span class="nav-main-link-name">Reponse analyse</span></a></li>
                    </ul>
                </li>
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        ...
                        <li class="nav-main-item"><a class="nav-main-link" href="{{route('hospitalisations.realise')}}"><span class="nav-main-link-name">Liste des hospitaliser</span></a></li>
                    </ul>
                </li>
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item"><a class="nav-main-link" href="#"><span class="nav-main-link-name">Tickets & Factures</span></a></li>
                        <li class="nav-main-item"><a class="nav-main-link" href="#"><span class="nav-main-link-name">Prestations</span></a></li>
                    </ul>
                </li>
