    ...
    <div class="block block-rounded mt-3">
        ...
        <div class="block-content">
            <div class="table-responsive">
                <table id="table-receptions"
                       class="table table-hover table-striped table-bordered table-vcenter">
...
$(document).ready(function() {
    ...
    let table = $('#table-receptions').DataTable({
        processing: true,
        serverSide: true,
        ...
        columns: [
            ...
            { data: 'pourcentage', orderable: false, searchable: false },
