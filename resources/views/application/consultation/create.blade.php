                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h4 class="mb-0 fw-bold">
                                    {{ $consultation ? 'Modifier la consultation' : 'Nouvelle consultation' }}</h4>
                            ...
                            <select id="patientDropdown" class="form-select form-select-sm border-0" required>
                                ...
                                @foreach ($tickets as $ticket)
                                    <option value="{{ $ticket->patient->id }}" data-ticket="{{ $ticket->id }}"
                                        ...
                                        {{ $ticket->patient->nom }} {{ $ticket->patient->prenom }} - Tel:
                                        {{ $ticket->patient->telephone }} - Âge: {{ $ticket->patient->age }} ans - Ticket
                                        N° {{ $ticket->id }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="card-body p-4 bg-light">
                        ...
                        <div class="card-body pt-0">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <textarea name="motif" class="form-control form-control-sm" rows="2"
                                        placeholder="Motif de consultation...">{{ $consultation->motif ?? '' }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold small text-secondary">Antécédents médicaux</label>
                                    <textarea name="antecedents" class="form-control form-control-sm" rows="2"
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="number" name="poids" class="form-control form-control-sm"
                                            min="1" step="0.1" value="{{ $consultation->poids ?? '' }}"
                                            placeholder="kg">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text bg-light"></span>
                                        <input type="number" name="taille" class="form-control form-control-sm"
                                            min="30" step="0.1" value="{{ $consultation->taille ?? '' }}"
                                            placeholder="cm">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text bg-light"></span>
                                        <input type="text" id="imc" class="form-control form-control-sm bg-light"
                                            readonly
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text bg-light"></span>
                                        <input type="text" name="tension" class="form-control form-control-sm"
                                            placeholder="Ex: 12/8" value="{{ $consultation->tension ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select name="groupe_sanguin" class="form-select js-select2 form-select-sm bg-light">
                                        ...
                                        @foreach (['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'] as $gs)
                                            <option value="{{ $gs }}"
                                                @if ($consultation && $consultation->groupe_sanguin == $gs) selected @endif>{{ $gs }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text bg-light"></span>
                                        <input type="text" name="adresse_patient" class="form-control form-control-sm"
                        ...
                        <div class="card-body pt-0">
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <select id="symptomes" class="form-select  js-select2 form-select-sm bg-light"
                                        name="symptomes[]" multiple size="3">
                                    ...
                                    <small class="text-muted" style="font-size: 0.7rem;">Ctrl + clic pour sélectionner
                                        plusieurs</small>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold small text-secondary">Maladie / Pathologie</label>
                                    <select name="maladie_id" id="maladieSelect"
                                        class="form-select js-select2 form-select-sm bg-light" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control form-control-sm" name="diagnostic" placeholder="Saisir le diagnostic..."
                                        rows="3" required>{{ $consultation->diagnostic ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <select name="medicaments[]"
                                                                            class="form-select  js-select2 form-select-sm selectMedicament"
                                                                            required>
                                                    ...
                                                    @forelse($consultation->examens ?? [] as $ex)
                                                        <li class="list-group-item px-0 d-flex gap-2 align-items-center">
                                                            ...
                                                            <input type="text" name="examens[]"
                                                                ...
                                                                placeholder="Nom de l'examen" value="{{ $ex->examen }}"
                                                                required>
                                                            <button type="button"
                                                    ...
                                                    @forelse($consultation->rendezVous ?? [] as $r)
                                                        <li class="list-group-item px-0">
                                                            <div class="row g-2 align-items-center">
                                                                <div class="col-5"><input type="text" name="rdv_motifs[]"
                                                                        class="form-control form-control-sm"
                                                                        placeholder="Motif" value="{{ $r->motif }}"
                                                                        required></div>
                                                                <div class="col-3"><input type="date" name="rdv_dates[]"
                                                                        class="form-control form-control-sm"
                                                                        value="{{ \Carbon\Carbon::parse($r->date_heure)->format('Y-m-d') }}"
                                                                        required></div>
                                                                <div class="col-3"><input type="time" name="rdv_heures[]"
                                                                        class="form-control form-control-sm"
                                                                        value="{{ \Carbon\Carbon::parse($r->date_heure)->format('H:i') }}"
                                                                        required></div>
                                                                <div class="col-1 text-end"><button type="button"
                    ...
                    <div class="card shadow-sm mb-4 border-0">
                        ...
                        <div class="card-body pt-0">
                            <div class="row g-3">
                                <div class="col-12">
                                    <textarea class="form-control form-control-sm" name="certificat" placeholder="Certificat médical (optionnel)..."
                                        rows="2">{{ $consultation->certificat->contenu ?? '' }}</textarea>
                                </div>
                                <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label fw-semibold" for="hospitalisationCheck"> Proposer
                                            une hospitalisation</label>
                                    </div>
                                </div>
                                <div id="hospitalisationFields"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="litSelect" name="lit_id" class="form-select form-select-sm">
                                                ...
                                                @if ($consultation && $consultation->hospitalisation && $consultation->hospitalisation->lit_id)
                                                    <option value="{{ $consultation->hospitalisation->lit_id }}" selected>
                                                        Lit #{{ $consultation->hospitalisation->lit_id }}</option>
                                                @endif
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="observations"
                                                class="form-control form-control-sm" placeholder="Observations"
