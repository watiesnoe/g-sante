...
<body>
    @include('layouts.pdf_header', [
        'docNumber' => 'ORD-' . date('Ymd') . '-' . ($ordonnance->id ?? ($patient->id ?? '0')),
    ])
        ...
        <table style="width: 100%; border: none;">
            <tr>
                <td style="width: 70%; border: none; padding: 0;">
                    ...
                    <div style="font-size: 14px; font-weight: bold;">{{ $patient->nom_patient }}
                        {{ $patient->prenom_patient }}</div>
            ...
            @foreach ($medicaments as $med)
                <tr>
                    ...
                    <td style="text-align: right; vertical-align: middle;">
                        ...
                        @else
                            {{ number_format(($med->prix_vente ?? 0) * ($med->pivot->quantite ?? 1), 0, ',', ' ') }}
                            FCFA
                        @endif
                    </td>
                </tr>
