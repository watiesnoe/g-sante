                            ...
                            <div class="col-md-6">
                                ...
                                <select name="statut" class="form-select" required>
                                    @foreach ($statuts as $key => $label)
                                        <option value="{{ $key }}" {{ old('statut', $user->statut) === $key ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                @if($user->photo)
                                    <img src="{{ asset('storage/'.$user->photo) }}" class="mt-2 rounded" width="60" height="60" style="object-fit: cover;">
                                @endif
                            </div>
                                                    ...
                                                    <div class="card-body p-2">
                                                        @foreach($modulePermissions as $permission)
                                                            <div class="form-check form-switch mb-1">
                                                                @php
                                                                    $isChecked = in_array($permission->name, old('permissions', $userPermissions));
                                                                @endphp
